    ...
    <div class="bg-bolt-card border border-border-default rounded-lg overflow-hidden">
      ...
      <div class="p-5 pt-4 space-y-4">
        ...
        <div>
          ...
          <p class="description">The timezone used to display timestamps in the dashboard.</p>
        </div>
      </div>
      <div class="px-5 py-4 border-t border-border-default flex items-center justify-end gap-3">
        <span v-if="success" class="text-xs text-green-400 mr-auto">Settings saved.</span>
